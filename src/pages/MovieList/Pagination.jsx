 ...
 * @param {Number} count to compute max page
 * @param {Number} pageSize to compute max page
 * @param {Function} setStatePage parent function
...
const Pagination = ({
  ...
  const maxPage =
    Math.floor(count / pageSize) === count / pageSize
